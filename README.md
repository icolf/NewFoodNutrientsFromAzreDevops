...
I follow code-first aproach and used MS SQL Server as database in a VisualStudio 2017 environment and Visual Studi Tem Services/Team Foundation 2017 with Git as source control manager.
